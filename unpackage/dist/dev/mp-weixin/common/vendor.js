...
/***/ 19:
/*!***********************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/store/store.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _logger = _interopRequireDefault(__webpack_require__(/*! vuex/dist/logger */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setChatList: function setChatList(state, chatList) {
...
/***/ 21:
/*!*************************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/common/config.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.webUrl = void 0; // 配置信息
// api请求前缀
var webUrl = 'http://localhost:3000/';exports.webUrl = webUrl;

/***/ }),

/***/ 22:
/*!********************************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/config/requestConfig.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var baseUrl =  true ? "http://192.168.31.164:8081/" : undefined;
...
/***/ 23:
/*!**************************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/config/request.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@vue/babel-preset-app/node_modules/@babel/runtime/regenerator */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var request = /*#__PURE__*/function () {
  function request(options) {_classCallCheck(this, request);
  ...
  }_createClass(request, [{ key: "setLoading", value: function setLoading(
    boo) {
      this.loading = boo;
    } }, { key: "get", value: function get()
    {var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    } }, { key: "uploudFile", value: function uploudFile(
    url, file) {var _this = this;
      return new Promise(function (resolve, reject) {
        var Authorization = uni.getStorageSync('token');
        uni.uploadFile({
          url: _this.baseUrl + url, //仅为示例，非真实的接口地址
          filePath: file.path,
          header: {
    ...
    } }, { key: "websocket", value: function () {var _websocket = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var method,url,data,options,h,socketTask,_args = arguments;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                method = _args.length > 0 && _args[0] !== undefined ? _args[0] : "GET";url = _args.length > 1 && _args[1] !== undefined ? _args[1] : '';data = _args.length > 2 && _args[2] !== undefined ? _args[2] : {};options = _args.length > 3 && _args[3] !== undefined ? _args[3] : {};
                this.headers.Authorization = uni.getStorageSync('token');
                h = Object.assign(_objectSpread({}, this.headers), options);_context.next = 8;return (
                  uni.connectSocket({
                    ...
                    } }));case 8:socketTask = _context.sent;return _context.abrupt("return",

                socketTask);case 10:case "end":return _context.stop();}}}, _callee, this);}));function websocket() {return _websocket.apply(this, arguments);}return websocket;}() }, { key: "ajax", value: function ajax()



    {var _this2 = this;var method = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "GET";var url = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
      this.headers.Authorization = uni.getStorageSync('token');
      var h = Object.assign(_objectSpread({}, this.headers), options);
      return new Promise(function (resolve, reject) {
        if (_this2.loading) {
          uni.showLoading({
            title: '加载中' });
...
/***/ 24:
/*!**********************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/common/lib.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 21));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 网络监听
var NetWork = { // 网络状态
...
/***/ 4:
/*!*******************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/pages.json ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 47:
/*!***********************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/common/time.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!************************************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/pages.json?{"type":"style"} ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "韩府帮" }, "pages/news/news": { "navigationBarTitleText": "最近动态" }, "pages/paper/paper": { "enablePullDownRefresh": true, "navigationBarTitleText": "消息" }, "pages/home/home": { "navigationBarTitleText": "我的" }, "pages/search/search": { "enablePullDownRefresh": true }, "pages/add-input/add-input": {}, "pages/topic-nav/topic-nav": { "navigationBarTitleText": "话题分类" }, "pages/topic-detail/topic-detail": { "enablePullDownRefresh": true }, "pages/user-list/user-list": {}, "pages/user-chat/user-chat": { "navigationBarTitleText": "聊天页" }, "pages/detail/detail": { "navigationBarTitleText": "详情" }, "pages/user-set/user-set": { "navigationBarTitleText": "设置" }, "pages/user-set-repassword/user-set-repassword": { "navigationBarTitleText": "修改密码" }, "pages/user-set-email/user-set-email": { "navigationBarTitleText": "修改邮箱" }, "pages/user-set-userinfo/user-set-userinfo": { "navigationBarTitleText": "修改资料" }, "pages/user-set-help/user-set-help": { "navigationBarTitleText": "意见反馈" }, "pages/user-set-about/user-set-about": { "navigationBarTitleText": "关于韩府" }, "pages/login/login": {}, "pages/user-space/user-space": { "navigationBarTitleText": "个人空间" }, "pages/register/register": { "navigationBarTitleText": "注册" }, "pages/user-history/user-history": { "navigationBarTitleText": "浏览历史" }, "pages/user-search/user-search": { "enablePullDownRefresh": true } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "韩府帮", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#FFFFFF" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!***********************************************************!*\
  !*** D:/桌面文件/mypro/韩府/韩府帮/韩府帮/pages.json?{"type":"stat"} ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
