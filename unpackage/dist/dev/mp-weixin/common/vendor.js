...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "韩府帮" }, "pages/news/news": { "navigationBarTitleText": "最近动态" }, "pages/paper/paper": { "enablePullDownRefresh": true, "navigationBarTitleText": "小纸条" }, "pages/home/home": { "navigationBarTitleText": "我的" }, "pages/search/search": { "enablePullDownRefresh": true }, "pages/add-input/add-input": {}, "pages/topic-nav/topic-nav": { "navigationBarTitleText": "话题分类" }, "pages/topic-detail/topic-detail": { "enablePullDownRefresh": true }, "pages/user-list/user-list": {}, "pages/user-chat/user-chat": { "navigationBarTitleText": "聊天页" }, "pages/detail/detail": { "navigationBarTitleText": "详情" }, "pages/user-set/user-set": { "navigationBarTitleText": "设置" }, "pages/user-set-repassword/user-set-repassword": { "navigationBarTitleText": "修改密码" }, "pages/user-set-email/user-set-email": { "navigationBarTitleText": "修改邮箱" }, "pages/user-set-userinfo/user-set-userinfo": { "navigationBarTitleText": "修改资料" }, "pages/user-set-help/user-set-help": { "navigationBarTitleText": "意见反馈" }, "pages/user-set-about/user-set-about": { "navigationBarTitleText": "关于韩府" }, "pages/login/login": {}, "pages/user-space/user-space": { "navigationBarTitleText": "个人空间" }, "pages/register/register": {} }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "韩府帮", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#FFFFFF" } };exports.default = _default;
