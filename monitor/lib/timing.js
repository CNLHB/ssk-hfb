    ...
    onload(function () {
        setTimeout(() => {
            ...
            tracker.send({
                ...
                firstPaint: FP==null?"":FP.startTime,
                firstContentfulPaint: FCP==null?"":FCP.startTime,
                firstMeaningfulPaint: FMP==null?"":FMP.startTime,
                largestContentfulPaint: LCP==null?"": LCP.startTime
            });
        }, 3000);
    });
